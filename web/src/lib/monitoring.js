// Module-level state for monitoring
let errors = [];
let performanceData = {};
...
function setupNetworkMonitoring() {
  ...
  window.addEventListener('online', () => {
    logEvent('Network Status', { status: 'online' });
  });

  window.addEventListener('offline', () => {
    logEvent('Network Status', { status: 'offline' });
  });

  // Monitor connection quality
  if ('connection' in navigator) {
    navigator.connection.addEventListener('change', () => {
      logEvent('Connection Change', {
 ...
 */
async function sendPerformanceToServer(perf) {
  try {
