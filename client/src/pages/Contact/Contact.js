    ...
    <div className="container fadeIn" id="contact">
      <div className="row">
        <div className="col-lg">
          <div className="jumbotron p-sm-5">
            ...
            <p>
              ...
              <a href={`tel:+${contactInfo[0].phone}`}>{contactInfo[0].phone.slice(0,3)}.{contactInfo[0].phone.slice(3,6)}.{contactInfo[0].phone.slice(6,)}</a>
            </p>
            <hr className="my-4" />
            <p>
              ...
              <a href={`mailto:${contactInfo[0].email}`}>{contactInfo[0].email.split("@")[0]}<span className="at@">@</span>{contactInfo[0].email.split("@")[1]}</a></p>
            <hr className="my-4" />
        ...
        <div className="col-lg sendmsg">
          <form action="https://formspree.io/contact@logansrun.com" method="POST">
